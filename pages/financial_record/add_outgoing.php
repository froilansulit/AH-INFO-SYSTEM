...
if (isset($FRO_nameSend) && isset($FRO_dateSend) && isset($FRO_purposeSend) && isset($FRO_ORSend) && isset($FRO_amountSend) && isset($FRO_monthSend) && isset($FRO_encodedSend)) {
    ...
    $sql1 = "INSERT into financial_record (cname,date_set,purpose,or_number,amount,month_date,encoded_by) values ('$FRO_nameSend', '$FRO_dateSend', '$FRO_purposeSend','$FRO_ORSend', '$FRO_amountSend', '$FRO_monthSend','$FRO_encodedSend')";
