                ...
                <div class="row">
                    <div class="col-md-12 grid-margin">
                        <div class="d-flex justify-content-between align-items-center">
                            <button type="button" class="btn btn-primary btn-icon-text btn-rounded btn-md">
                                <i class="ti-plus btn-icon-prepend"></i>Add New Employee
                            </button>
                            <div>
                            </div>
                        </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="#" data-toggle="tooltip" title="View">
                                                    <button type="button" class="btn btn-outline-dark btn-sm btn-rounded"><i class="ti-info btn-icon-prepend"></i></button>
                                                </a>
                                            </td>
                                        </tr>
                                        <?php
