...
$sql = "SELECT * FROM financial_record WHERE month_date='$currentMonth' AND year_date='$currentYear' AND purpose='Outgoing'"; // select all the data in DB
    ...
    <div class="container mt-5">
        ...
        <div class="card mt-5">
            <div class="card-body">
                ...
                <hr>
                <h4 class="text-center">Disbursement for the of Month of <?= $currentMonth ?></h4>
                <hr>
...
?>
                  ...
                  <hr>
                  <h4 class="float-right">Total: <?= '₱ ' . number_format($out_rec); ?></h4>
            </div>
        </div>
    </div>
