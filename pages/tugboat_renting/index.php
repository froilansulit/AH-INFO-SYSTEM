...
<body>
                          ...
                          ?>
                            ...
                            <td>
                              ...
                              <a href="#" data-toggle="tooltip" title="View">
                                <button type="button" class="btn btn-outline-dark btn-sm btn-rounded" onclick="ViewData(<?php echo $id; ?>)"><i class="ti-info btn-icon-prepend"></i></button>
                              </a>
                            </td>
  ...
  <script>
    ...
    //     $('#U_dor1').val(userID.dateofRent);
    //     $('#U_dor2').val(userID.dateofReturn);
    //   });
    ...
    // $(document).on('click', '#update_rent', function() {
    //     var Uname = $('#Uname').val();
    //     var U_dor1 = $('#U_dor1').val();
    //     var U_dor2 = $('#U_dor2').val();
    //     var hiddenRentData = $('#hiddenRentData').val();

    //     $("#lblUName").html("");
        

    //     if (Uname == "") {
    //       $("#lblUName").html("Enter Name");
    //     } 
    //     else {
    //       $("#lblUName").html("");
